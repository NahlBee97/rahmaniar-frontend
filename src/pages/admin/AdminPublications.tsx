...
const AdminPublications = () => {
  return (
    // Used a dark slate background to match the "Blue Theme" aesthetic
      ...
      <main className="flex-1 flex flex-col">
        <div className="grow p-6 lg:p-8">
          ...
          <header className="flex flex-wrap justify-between items-center gap-4 mb-8">
            ...
            <Link to={"/admin/publications/create"} className="flex min-w-[84px] cursor-pointer items-center justify-center gap-2 overflow-hidden rounded-lg h-10 px-4 bg-blue-500 text-white text-sm font-bold leading-normal tracking-[0.015em] hover:bg-blue-600 transition-colors">
              <AddIcon />
              <span className="truncate">Add New Publication</span>
            </Link >
          </header>
